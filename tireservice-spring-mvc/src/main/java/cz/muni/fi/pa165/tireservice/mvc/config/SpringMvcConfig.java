package cz.muni.fi.pa165.tireservice.mvc.config;
...
@EnableWebMvc
@Configuration
//@Import({SampleDataConfiguration.class}) TODO: add here import of sample data
@ComponentScan(basePackages = "cz.muni.fi.pa165.tireservice.mvc.controllers")
